...
namespace IO.Swagger.Model {
  ...
  public class CryptoEditVM {
    /// <summary>
    /// Gets or Sets GuidCryptoTransactionItem
    /// </summary>
    [DataMember(Name="guidCryptoTransactionItem", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "guidCryptoTransactionItem")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class CryptoEditVM {\n");
      sb.Append("  GuidCryptoTransactionItem: ").Append(GuidCryptoTransactionItem).Append("\n");
