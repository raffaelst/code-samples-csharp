...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class OperationEditVM {
    /// <summary>
    /// Gets or Sets IdOperationItem
    /// </summary>
    [DataMember(Name="idOperationItem", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "idOperationItem")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class OperationEditVM {\n");
      sb.Append("  IdOperationItem: ").Append(IdOperationItem).Append("\n");
