...
namespace IO.Swagger.Model {
  ...
  public class PushContentVM {
    ...
    /// <summary>
    /// Gets or Sets PushContentType
    /// </summary>
    [DataMember(Name="pushContentType", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "pushContentType")]
    public PushContentType PushContentType { get; set; }

    /// <summary>
    /// Gets or Sets NotStartUntil
    /// </summary>
    [DataMember(Name="notStartUntil", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "notStartUntil")]
    public DateTime? NotStartUntil { get; set; }

    /// <summary>
    /// Gets or Sets PushTargetType
    /// </summary>
    [DataMember(Name="pushTargetType", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "pushTargetType")]
    public PushTargetType PushTargetType { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class PushContentVM {\n");
      sb.Append("  Title: ").Append(Title).Append("\n");
      sb.Append("  Message: ").Append(Message).Append("\n");
      sb.Append("  PushContentType: ").Append(PushContentType).Append("\n");
      sb.Append("  NotStartUntil: ").Append(NotStartUntil).Append("\n");
      sb.Append("  PushTargetType: ").Append(PushTargetType).Append("\n");
