...
namespace IO.Swagger.Api
{
    ...
    public interface IHolidayApi
    {
        ...
        /// <returns></returns>
        void HolidayPost (string apiVersion);
    }
    ...
    public class HolidayApi : IHolidayApi
    {
        ...
        /// <param name="apiVersion"></param>
        /// <returns></returns>
        public void HolidayPost (string apiVersion)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling HolidayPost: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling HolidayPost: " + response.ErrorMessage, response.ErrorMessage);
