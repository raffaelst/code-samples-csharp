...
{
    public class SpreadsheetsUSAHelper : ISpreadsheetsUSAHelper
    {
        static readonly string[] Scopes = { SheetsService.Scope.Spreadsheets };
        static readonly string ApplicationName = "Dividendos";
        static readonly string SpreadsheetId = "1S113I4pJ9IvUy1VgNMksmUrn0dkDFWH-ND2_leHGtdo";
        static readonly string sheet = "Stock";
        static SheetsService service;

        public SpreadsheetsUSAHelper()
        {
