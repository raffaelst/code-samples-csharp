...
{
    public partial class ToroPlanTransaction
    {
        [JsonProperty("value")]
    ...
    public partial class MetaData
    {
        ...
        public string NextPagLink { get; set; }
    ...
    public partial class Value
    {
        ...
        public string OrderMarketType { get; set; }

        [JsonProperty("orderMaketTypeDescription")]
        public string OrderMaketTypeDescription { get; set; }
