...
{
    public class RDStationIntegrationApp : IRDStationIntegrationApp
    {
        ...
        public RDStationIntegrationApp(IUnitOfWork uow,
                            IMapper mapper,
        ...
        public void ReceiveInformationFromRDStationAndSendPushNotification(dynamic rootWebHook, RDStationPushNotificationType rDStationPushNotificationType)
        {
            ...
            switch (rDStationPushNotificationType)
            {
                ...
                case RDStationPushNotificationType.RequestSubscribe:
                    {
                        pushMessage = "Experimente a assinatura do app Dividendos.me por 3 dias grátis! Caso prefira, solicite a assinatura anual através da Toro Investimentos de forma 100% gratuita. Entre no seu app e saiba como solicitar.";
